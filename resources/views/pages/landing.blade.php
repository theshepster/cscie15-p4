...
@section('content')
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img class="first-slide" src={{ URL::asset('img/lightning.jpg') }} alt="Card">
                <div class="container">
            ...
            <div class="item">
                <img class="second-slide" src={{ URL::asset('img/playingcards.jpg') }} alt="Review">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Review</h1>
            ...
            <div class="item">
                <img class="third-slide" src={{ URL::asset('img/coal.jpg') }} alt="More">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>More Projects.</h1>
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img class="img-circle" src={{ URL::asset('img/flashlogo.png') }} alt="Card" width="140" height="140">
                <h2>So Flashy</h2>
            ...
            <!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img class="img-circle" src={{ URL::asset('img/deckofcards.jpg') }} alt="Deck" width="140" height="140">
                <h2>Decked Out</h2>
            ...
            <!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img class="img-circle" src={{ URL::asset('img/plussign.png') }} alt="More" width="140" height="140">
                <h2>More Projects</h2>
